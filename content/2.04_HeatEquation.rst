...
.. figure:: img/2Dto1DArrayMapping.png
    :align: center
    :scale: 50 %
...
.. typealong:: Initial CUDA port 
    ...
    .. tabs::
        ...
        .. tab:: CUDA (solution)
            ...
            .. literalinclude:: ../examples/CUDA/HeatEquation/solution/heat_equation_gpu_1.cu
                :language: CUDA
...
.. typealong:: Moving the data ownership to the device
    ...
    .. tabs::
        ...
        .. tab:: CUDA: device owns the data (solution)
            ...
            .. literalinclude:: ../examples/CUDA/HeatEquation/solution/heat_equation_gpu_2_remove_copy_calls.cu
                :language: CUDA
...
.. typealong:: Use shared memory
    ...
    .. tabs::
        ...
        .. tab:: CUDA: use shared memory (solution)
            ...
            .. literalinclude:: ../examples/CUDA/HeatEquation/solution/heat_equation_gpu_3_shared_memory.cu
                :language: CUDA
